...
3. **Handoff directory** - Where to save your handoff (usually `thoughts/shared/handoffs/events/`)
...
```bash
ls thoughts/shared/handoffs/events/codebase-map.md
```
...
Handoff: thoughts/shared/handoffs/events/plan-<description>.md
