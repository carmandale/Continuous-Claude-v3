...
Usage:
  python ~/.claude/scripts/core/backfill_memory_project.py --dry-run
  python ~/.claude/scripts/core/backfill_memory_project.py --project "/path/to/project"
  python ~/.claude/scripts/core/backfill_memory_project.py
"""
